<?php
namespace The7\Adapters\Elementor\QueryControl;
...
use The7\Adapters\Elementor\QueryControl\Controls\The7_Control_Query;
...
class The7_Query_Control_Module{
	...
	public function register_controls() {
		...
		$controls_manager->add_group_control( The7_Group_Control_Query::get_type(), new The7_Group_Control_Query() );
		$controls_manager->register_control( self::QUERY_CONTROL_ID, new The7_Control_Query() );
	}
	...
	public function register_ajax_actions( $ajax_manager ) {
		$ajax_manager->register_ajax_action( 'the7_query_control_value_titles', [ $this, 'ajax_posts_control_value_titles' ] );
		$ajax_manager->register_ajax_action( 'the7_panel_posts_control_filter_autocomplete', [ $this, 'ajax_posts_filter_autocomplete' ] );
		/**
		 * @deprecated 2.6.0 use new `autocomplete` format
		 */
		$ajax_manager->register_ajax_action( 'the7_query_control_value_titles_deprecated', [ $this, 'ajax_posts_control_value_titles_deprecated' ] );
		$ajax_manager->register_ajax_action( 'the7_panel_posts_control_filter_autocomplete_deprecated', [ $this, 'ajax_posts_filter_autocomplete_deprecated' ] );
	}
