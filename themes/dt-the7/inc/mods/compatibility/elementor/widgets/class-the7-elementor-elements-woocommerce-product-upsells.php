<?php
/*
 * The7 elements product upsells widget for Elementor.
 *
 * @package The7
 */
...
class The7_Elementor_Elements_Woocommerce_Product_Upsells extends Widget_Base {

	public function get_name() {
		return 'the7-woocommerce-product-upsell';
	}

	public function get_title() {
		return __( 'Upsells', 'the7mk2' );
	}

	public function get_icon() {
		return 'eicon-product-upsell the7-widget';
	}

	public function get_keywords() {
		return [ 'woocommerce', 'shop', 'store', 'upsell', 'product', 'the7' ];
	}
	...
	protected function render() {
        ...
        <div class="the7-elementor-widget the7-elementor-product-<?php echo esc_attr( wc_get_product()->get_type() ); ?>">
			<?php
			add_filter( 'woocommerce_product_upsells_products_heading', [ $this, 'set_heading' ] );
			woocommerce_upsell_display();
			remove_filter( 'woocommerce_product_upsells_products_heading', [ $this, 'set_heading' ] );
			?>
        </div>
		<?php
	}
